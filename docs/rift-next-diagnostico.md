# Reporte de Diagnóstico: apps/rift-next

Este documento consolida los hallazgos de la auditoría técnica realizada sobre el componente `rift-next`, abarcando arquitectura, uso de Effect-TS, cobertura de pruebas, seguridad y deuda técnica.

## 1. Arquitectura

### 1.1. Cast de borrado de entorno en RealtimeService
- **Severidad:** High
- **Ubicación:** `apps/rift-next/src/core/realtime/realtime-service.ts:159-161`
...
- **Severidad:** Medium
- **Ubicación:** `apps/rift-next/src/core/database/database.ts`
...
- **Severidad:** High
- **Ubicación:** `apps/rift-next/src/index.ts:277-279` (y sus usos en handlers de WS)
...
- **Severidad:** High
- **Ubicación:** `apps/rift-next/src/core/database/database-service.ts:164-170`
...
- **Severidad:** Medium
- **Ubicación:** `apps/rift-next/tests/`
...
- **Severidad:** Medium
- **Ubicación:** `apps/rift-next/src/index.ts:96-115`
...
- **Severidad:** Medium
- **Ubicación:** `apps/rift-next/src/core/http/http-schemas.ts`
