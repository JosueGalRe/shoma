  ...
  return (
    <Card className="border-gray-800 bg-gray-950 text-white">
      <CardHeader>
        ...
        <CardDescription className="text-gray-400">Pending lobby invitations.</CardDescription>
      </CardHeader>
      <CardContent className="space-y-4">
        ...
        {invites.length === 0 && !isLoading ? <p className="text-sm text-gray-400">No pending invites</p> : null}
