      ...
      <div class="ready-prompt" v-if="shouldShow">
        <div class="progress-bar">
          <div
            class="progress"
            :style="progressWidth"
            :class="{ accepted: state.playerResponse === 'Accepted', declined: state.playerResponse === 'Declined' }"
          ></div>
        </div>

        <div class="header">Match Found</div>

        <lcu-button @click="accept" type="confirm" class="accept-button" :disabled="hasResponded"> Accept! </lcu-button>

        <lcu-button @click="decline" class="decline-button" :disabled="hasResponded"> Decline </lcu-button>
      </div>
    </transition>
  </div>
</template>
