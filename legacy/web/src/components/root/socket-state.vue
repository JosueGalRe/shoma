<template>
  <div class="socket-state">
    ...
    <template v-if="!socket">
      ...
      <p>
        Enter your computer code to start controlling League from your phone. You can find the code by right-clicking on the
        Mimic icon in the bottom right of your computer.
      </p>
    ...
    <template v-else-if="didFailPubkey">
      ...
      <p style="margin-bottom: 40px">
        The computer belonging to the code you entered could not be found. Make sure that both Conduit and League are running
        and that you entered the code correctly.
      </p>
    ...
    <template v-else-if="didGetDenied">
      ...
      <p style="margin-bottom: 40px">
        The computer at {{ code }} explicitly denied the connection attempt. When connecting, make sure to press <b>Allow</b> on
    ...
    <template v-else-if="isConnecting">
      ...
      <p style="margin-bottom: 40px">
        Trying to connect to Mimic HQ... If this takes longer than a few seconds, check your internet connection.
      </p>
    ...
    <template v-else-if="isHandshaking">
      ...
      <p style="margin-bottom: 40px">
        Mimic is waiting for your desktop to approve the connection. Simply click the "Allow" button on your computer to accept
        the connection. Don't worry: you'll only have to do this once per device.
      </p>
