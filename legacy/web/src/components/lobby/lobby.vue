    ...
    <div v-if="state" class="lobby" :style="backgroundImage">
      ...
      <div class="bottom">
        ...
        <lcu-button
          ...
          :disabled="!(state.canStartActivity && queueDodgeTime === -1 && state.localMember.isLeader)"
        >
      ...
      <div class="no-lobby" v-show="!creatingLobby">
        ...
        <span v-if="!isStandalone" class="tip">
          ...
          <template v-if="canTriggerHomescreenPrompt">
            <highlightable
              ><span style="text-decoration: underline" @click="triggerInstallPrompt"
                >Add this site to your homescreen</span
              ></highlightable
            >
          </template>

          <template v-else> Add this site to your homescreen </template>
