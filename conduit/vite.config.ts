...
export default {
  ...
  fmt: {
    ...
    semi: false,
    trailingComma: 'all',
    ignorePatterns: ['**/node_modules/**', '**/dist/**', '**/*.d.ts', '**/routeTree.gen.ts', '**/tsconfig.tsbuildinfo'],
    sortImports: {
  ...
  lint: {
    ...
    overrides: [
      ...
      {
        files: ['conduit/src/routes/**/*.{ts,tsx}', 'conduit/src/components/ui/**/*.{ts,tsx}'],
        rules: {
