...
export const PLATFORM_ID_TO_REGION_CODE: Record<string, string> = {
  BR1: 'BR',
  EUN1: 'EUNE',
  EUW1: 'EUW',
  JP1: 'JP',
...
export const TENCENT_PLATFORM_IDS = new Set([
  'BGP1',
  'BGP2',
  'CQ100',
  'EDU1',
...
function hasItemsProperty(value: unknown): value is { items: unknown } {
...
export function isRegaliaBannerInventoryEntry(value: unknown): value is RegaliaBannerInventoryEntry {
  return hasItemsProperty(value) && Array.isArray(value.items)
}
