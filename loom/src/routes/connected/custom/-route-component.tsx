...
export function CustomRouteComponent() {
  ...
  function updateRoomConfig(nextConfig: Partial<{ roomName: string; password: string; mapId: number; gameMode: string }>) {
    setRoomConfig({
      gameMode: nextConfig.gameMode ?? gameMode,
      mapId: nextConfig.mapId ?? mapId,
      name: nextConfig.roomName ?? roomName,
      password: nextConfig.password ?? password,
    })
  }
