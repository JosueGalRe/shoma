export const lobbyStyles = {
  ...
  cancelButton:
    'w-full rounded-full border border-[color-mix(in_srgb,rgb(200,170,110)_60%,transparent)] bg-[color-mix(in_srgb,rgb(10,20,40)_60%,transparent)] px-6 py-3 text-xs font-bold tracking-widest text-[rgb(200,170,110)] uppercase backdrop-blur-md transition-all hover:border-[color-mix(in_srgb,rgb(200,170,110)_80%,transparent)] hover:bg-[color-mix(in_srgb,rgb(200,170,110)_10%,transparent)] hover:backdrop-blur-lg active:scale-[0.98]',
  findMatchButton:
