...
export class InvalidTokenError extends Schema.TaggedErrorClass<InvalidTokenError>()('InvalidTokenError', {
  cause: Schema.Defect,
}) {}

export function missingJwtSecret(operation: HttpOperation): MissingJwtSecretError & { readonly operation: HttpOperation } {
